...
public class UserServiceLocator extends org.apache.axis.client.Service implements main.UserService {
    ...
    private java.lang.String User_address = "http://localhost:8080/AuctionSite/services/User";
    ...
    public main.User getUser(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.UserSoapBindingStub _stub = new main.UserSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.User.class.isAssignableFrom(serviceEndpointInterface)) {
                main.UserSoapBindingStub _stub = new main.UserSoapBindingStub(new java.net.URL(User_address), this);
                _stub.setPortName(getUserWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "UserService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "User"));
        }
